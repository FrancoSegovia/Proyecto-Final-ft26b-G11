...
router.post("/signup", adminController.signup); //*REGISTRO
router.get("/confirm/:token", adminController.confirmAccount); //*EMAIL Y VERIFICACION
router.post("/login", adminController.login); //*LOGUEO
